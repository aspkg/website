...
Rainbow.extend(
  ...
  [
    ...
    { name: "entity.label", pattern: /\w+:/g },
    {
      ...
      pattern:
        /\b((un)?signed|const)? ?(void|char|short|int|long|float|double)\*? +((\w+)(?= ?\())?/g,
    },
    {
  ...
  Rainbow.extend("csharp", [
    ...
    },
    {
      name: "preprocessor",
      pattern:
        /(\#if|\#else|\#elif|\#endif|\#define|\#undef|\#warning|\#error|\#line|\#region|\#endregion|\#pragma)[\s\S]*?$/gm,
    },
  ]),
  Rainbow.extend(
    "coffeescript",
  ...
  Rainbow.extend(
    ...
    [
      ...
      },
      {
        name: "storage.type",
        pattern:
          /\b(bool|byte|complex(64|128)|float(32|64)|func|interface|map|rune|string|struct|u?int(8|16|32|64)?|var)(?=\b)/g,
      },
  ...
  Rainbow.extend(
    ...
    [
      ...
      },
      {
        ...
        pattern:
          /\+|\!|\-|&(gt|lt|amp);|\/\=|\||\@|\:|\.|\+{2}|\:|\*|\=|#|\.{2}|(\\)[a-zA-Z_]/g,
      },
      {
        name: "keyword",
        pattern:
          /\b(case|class|foreign|hiding|qualified|data|family|default|deriving|do|else|if|import|in|infix|infixl|infixr|instance|let|in|otherwise|module|newtype|of|then|type|where)\b/g,
      },
  ...
  Rainbow.extend("java", [
    ...
    { name: "entity.class", pattern: /\b([A-Z]\w*)\b/g },
    {
      name: "operator",
      pattern:
        /(\+{1,2}|-{1,2}|~|!|\*|\/|%|(?:&lt;){1,2}|(?:&gt;){1,3}|instanceof|(?:&amp;){1,2}|\^|\|{1,2}|\?|:|(?:=|!|\+|-|\*|\/|%|\^|\||(?:&lt;){1,2}|(?:&gt;){1,3})?=)/g,
    },
  ]),
  Rainbow.extend(
    "javascript",
  ...
  Rainbow.extend("lua", [
    ...
    },
    {
      matches: { 1: "keyword" },
      pattern:
        /\b((a|e)nd|in|repeat|break|local|return|do|for|then|else(if)?|function|not|if|or|until|while)(?=\b)/gi,
    },
  ...
  Rainbow.extend(
    ...
    [
      ...
      },
      {
        ...
        pattern:
          /\b(NULL|NA|TRUE|FALSE|T|F|NaN|Inf|NA_integer_|NA_real_|NA_complex_|NA_character_)\b/g,
      },
      {
      ...
      },
      {
        ...
        pattern:
          /([a-zA-Z][a-zA-Z0-9._]+)([:]{2,3})([.a-zA-Z][a-zA-Z0-9._]*(?=\s*\())\b/g,
      },
      {
        name: "support.function",
        pattern:
          /(^|[^0-9a-zA-Z\._])(array|character|complex|data\.frame|double|integer|list|logical|matrix|numeric|vector)(?=\s*\()/g,
      },
    ],
    "generic"
  ),
  Rainbow.extend("ruby", [
    ...
    { name: "variable.instance", pattern: /@([a-zA-Z_]\w*)\b/g },
    {
      ...
      pattern:
        /[^\.]\b(BEGIN|begin|case|class|do|else|elsif|END|end|ensure|for|if|in|module|rescue|then|unless|until|when|while)\b(?![?!])/g,
    },
    {
      matches: { 1: "keyword.control.pseudo-method" },
      pattern:
        /[^\.]\b(alias|alias_method|break|next|redo|retry|return|super|undef|yield)\b(?![?!])|\bdefined\?|\bblock_given\?/g,
    },
    {
      matches: { 1: "constant.language" },
    ...
    },
    {
      ...
      pattern:
        /\b(require|gem|initialize|new|loop|include|extend|raise|attr_reader|attr_writer|attr_accessor|attr|catch|throw|private|module_function|public|protected)\b(?![?!])/g,
    },
    {
      name: "keyword.operator",
      pattern:
  ...
  Rainbow.extend("scheme", [
    ...
    },
    {
      matches: { 1: "keyword" },
      pattern:
        /\(\s*(begin|define\-syntax|if|lambda|quasiquote|quote|set!|syntax\-rules|and|and\-let\*|case|cond|delay|do|else|or|let|let\*|let\-syntax|letrec|letrec\-syntax)(?=[\]()\s#])/g,
    },
    {
  ...
  Rainbow.extend("shell", [
    ...
    { name: "storage.function", pattern: /(.+?)(?=\(\)\s{0,}\{)/g },
    {
      ...
      pattern:
        /\b(echo|rm|ls|(mk|rm)dir|cd|find|cp|exit|pwd|exec|trap|source|shift|unset)/g,
    },
    {
      matches: { 1: "keyword" },
      pattern:
        /\b(break|case|continue|do|done|elif|else|esac|eval|export|fi|for|function|if|in|local|return|set|then|unset|until|while)(?=\b)/g,
    },
  ]),
